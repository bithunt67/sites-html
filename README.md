...
<head>
    ...
    <title>PostBoot - Página Inicial</title>
    <style>
        body {
...
<body>
    <header>
        <!-- Substitua 'logo.png' pelo caminho real da sua imagem de logo (robô com "postBoot") -->
        <img src="logo.png" alt="Logo do PostBoot - Um robô com o texto postBoot">
